...
public class JMSConfiguration {
    ...
    @Bean
    public ConnectionFactory jmsConnectionFactory(@Value("${BUS_USER}") final String username, @Value("${BUS_PASS}") final String password, @Value("${BUS_HOST}") final String hostname, @Value("${info.build.name}") final String clientId) {
